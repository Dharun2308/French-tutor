...
Use familiar A1–A2 words: greetings, family, basic food/drink, simple places, colours, numbers and everyday needs. The source's own A2 expression is welcome; keep the surrounding language basic. Target ONE skill. Do not add unfamiliar verbs, idioms, object-pronoun combinations, subordinate clauses, extra tenses or several grammar rules just to vary the exercise. Use the present for new contexts; an already-taught short source expression may retain its original construction.
Supported means a word group or very short phrase, usually 1–4 words, because the learner needs extra practice. Standard means about 2–6 words. Stretch still stays within A1–A2, about 3–8 words, with at most one familiar detail. NEVER exceed 8 French words. Do not make the source more complex after an Again or Hard rating. If a short source phrase is already the right exercise, reusing it is fine.
