...
export default function VariationsPage() {
  ...
  return <main className="container max-w-xl py-6">
    ...
    <h1 className="mb-5 text-2xl font-semibold">Fresh contexts</h1>
    {!items ? <div className="h-48 animate-pulse rounded-xl bg-muted"/> : items.length === 0 ? <Card><CardContent className="py-10 text-center"><Sparkles className="mx-auto mb-3 h-8 w-8"/><p className="font-medium">Nothing needs a new angle yet</p></CardContent></Card> : <Card><CardContent className="space-y-5 p-6">
